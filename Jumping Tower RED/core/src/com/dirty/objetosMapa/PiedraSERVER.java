...
public class PiedraSERVER extends InteractiveTileObjectSERVER {

	public PiedraSERVER(World world, TiledMap map, Rectangle rect, JugadorBASESERVER jugador) {
