...
public class CieloSERVER extends InteractiveTileObjectSERVER {
	public CieloSERVER(World world, TiledMap map, Rectangle rect, JugadorBASESERVER jugador) {
