...
public class TextoSERVER {
	...
	public TextoSERVER(String rutaFuente, int dimension, Color color, boolean sombra) {
	...
	public void dibujar() {
		fuente.draw(UtilesSERVER.batch, texto, x, y); // Dibuja el texto
	}
